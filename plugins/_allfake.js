...
handler.all = async function (_0x439f91) {
  ...
  try {
    ...
    global.kontak2 = [[owner[0], await conn.getName(owner[0] + "963980677944@s.whatsapp.net"), "KHALED SHATAH", "https://whatsapp.com", true]];
    const _0x37f038 = {
      fromMe: false,
    ...
    const _0x21b246 = {
      ...
      serverMessageId: 103,
      newsletterName: "📡سرعه النت : " + _0xfd7158 + "   © [ مطور ستوريات ]    "
    };
    global.adReply = {
      contextInfo: {
        forwardingScore: 1,
